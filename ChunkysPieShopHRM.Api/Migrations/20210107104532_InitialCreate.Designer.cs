...
namespace ChunkysPieShopHRM.Api.Migrations
{
    ...
    [Migration("20210107104532_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChunkysPieShopHRM.Shared.Country", b =>
                {
            ...
            modelBuilder.Entity("ChunkysPieShopHRM.Shared.Employee", b =>
                {
            ...
            modelBuilder.Entity("ChunkysPieShopHRM.Shared.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ChunkysPieShopHRM.Shared.Employee", b =>
                {
                    b.HasOne("ChunkysPieShopHRM.Shared.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ChunkysPieShopHRM.Shared.JobCategory", "JobCategory")
                        .WithMany()
